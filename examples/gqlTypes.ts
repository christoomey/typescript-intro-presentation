...
export type StarRepo_addStar_starrable =
  | StarRepo_addStar_starrable_Gist
  | StarRepo_addStar_starrable_Repository;
...
export type UnstarRepo_removeStar_starrable =
  | UnstarRepo_removeStar_starrable_Gist
  | UnstarRepo_removeStar_starrable_Repository;
...
export type UserSearch_search_edges_user =
  | UserSearch_search_edges_user_Issue
  | UserSearch_search_edges_user_User;
